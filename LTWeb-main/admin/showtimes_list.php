...
<div class="max-w-6xl mx-auto bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-xl my-6">
                        ...
                        <tr class="hover:bg-slate-800/50">
                            ...
                            <td class="p-3 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <!-- Nút xóa kích hoạt SweetAlert2 -->
                                    <a href="javascript:void(0)" onclick="confirmDeleteShowtime(<?= $s['id'] ?>)" class="p-2 bg-rose-500/10 text-rose-400 hover:bg-rose-500 hover:text-white rounded-lg transition-all text-xs" title="Xóa">
...
function confirmDeleteShowtime(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = 'showtimes_list.php?delete_id=' + id;
        }
    });
}
</script>
